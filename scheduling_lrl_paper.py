"""
Scheduling Experiment with TIME-BASED OVERLAPS (CORRECT VERSION)
==================================================================

The problem: Given N meetings with time ranges [start, end] and M rooms,
determine if all meetings can be scheduled without conflicts.

This is the version that got 91.3% accuracy!
"""
...
def main():
    ...
    print("="*80)
    print()
    print(f"Baseline (no LRL):        {stage1_results['accuracy']:.1%}")
    print(f"Bootstrap (training):     {stage2_results['accuracy']:.1%}")
    print(f"Test with LRL:            {stage3_results['accuracy']:.1%}")
    print()
    
    improvement = stage3_results['accuracy'] - stage1_results['accuracy']
    print(f"LRL Improvement: {improvement:+.1%}")
    print()
    print("="*80)
    print()
    print("📝 Review logs:")
    ...
    # Save results
    results_file = Path("scheduling_lrl_results.json")
